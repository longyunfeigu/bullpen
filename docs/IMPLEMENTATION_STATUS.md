...
| SHELL-V3. Task-centric shell (ADR-0008, PIVOT-021..025) | IN_PROGRESS | | Phases: 1 fixes (labels/icons/review-collisions/danger-hierarchy) → 2 Studio reskin → 3 Task Room + entry consolidation → 4 Live Board |
